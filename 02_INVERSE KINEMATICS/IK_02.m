...
% From random value
% px = -60; py = 80; pz = -100; gốc
%y = roll, b = pitch, a = yaw;
% yaw = -0.3; pitch = 0.3; roll = -0.3; gốc
% test
px = 450; py = -100; pz = 500;
yaw = pi/2; pitch = pi/2; roll = pi/2;
...
% the1_d = pi; the2_d = pi/2; the3_d = pi/3; the4_d = pi/4; the5_d = pi/5; the6_d = pi/6; 
